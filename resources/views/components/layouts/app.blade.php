...
<!-- End Meta Pixel Code -->
    ...
    <title>@yield('title', $title ?? 'NASA Shopping - Premium Fashion')</title>
    ...
    <footer class="bg-naas-green text-white mt-20">
        <div class="max-w-[85rem] mx-auto px-4 md:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <ul class="space-y-3 text-sm">
                        @php
                            $infoPages = \App\Models\Page::active()
                                ->whereIn('type', ['privacy_policy', 'terms_conditions', 'about_us', 'contact'])
                                ->ordered()
                                ->get();
                        @endphp
                        ...
                        <li><a href="#" class="hover:text-naas-terracotta transition">Shipping & Returns</a></li>
                        <li><a href="#" class="hover:text-naas-terracotta transition">FAQ</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="flex space-x-4 mt-6">
                        ...
                        <a href="#" class="hover:text-naas-terracotta transition">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="border-t border-gray-700 mt-12 pt-8 text-center text-xs text-gray-400">
                © 2026 NASA — naasshoping.pk.  All rights reserved.
            </div>
        </div>
    </footer>
